...
train_x = '../../SourceCode/Data/FashionMnistTrainX'
train_y = '../../SourceCode/Data/FashionMnistTrainY'
test_x = '../../SourceCode/Data/FashionMnistTestX'
test_y = '../../SourceCode/Data/FashionMnistTestY'
