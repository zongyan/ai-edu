...
- 普通SGD, 学习率0.95
- 动量Momentum, 学习率0.1 <font color=green> 这个是针对梯度下降的优化方法</font>
- RMPSProp，学习率0.5 <font color=green> 这个是针对学习率的优化方法</font>
- Adam，学习率0.5 <font color=green> 这个是针对学习率的优化方法</font>
...
- Adam算法，因为可以被理解为Momentum和RMSProp的组合，所以比Momentum要平缓一些，比RMSProp要平滑一些。<font color=green>按照Section 15.3的说法，这个adam是相当于RMSProp + Momentum的效果。所以不要拿Momentum的梯度更新算法套进去。另外，也是因为这个adam是两种优化方法的或，所以才是选择Momentum & RMSProp作为比较对象的了。</font>
