...
<font color="green"> 上面这个公式和 $Z = XW+B$ 还是有区别的，一个针对的feedforward网络的计算，一个是loss函数对$W$求导的内容，两者还是有本质上的区别的。</font>
...
前10次迭代，损失函数值已经达到了`6.83e+66`，而且越往后运行值越大，最后终于溢出了。下面的损失函数历史记录也表明了这一过程。<font color="green"> 看上图的第二行代码。</font>
