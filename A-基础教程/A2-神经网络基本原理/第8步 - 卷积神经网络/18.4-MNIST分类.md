...
卷积核的大小如何选取呢？大部分卷积神经网络都会用1、3、5、7的方式递增，还要注意在做池化时，应该尽量让输入的矩阵尺寸是偶数，如果不是的话，应该在上一层卷积层加padding，使得卷积的输出结果矩阵的宽和高为偶数。<font color=blue> 这里就是有一些配置conv & pooling的建议；另外，就是根据Section 18.1 - 18.3的CNN来看，结构都是卷积层-激活层-池化层这么一种方式，这是一种较为通用的方式吗？</font>
...
<font color=red> 我暂时还是不明白，这个subsection 18.4.4到底想说个啥，还是我的领悟能力太低了。</font>
...
<font color=green> 这个section的代码，我暂时就是没有继续看一遍的了，因为和前面Section 18.1 -- 18.3没有太大的区别。</font>
